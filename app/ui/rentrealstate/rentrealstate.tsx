...
export default function RentRealState() {
    ...
    async function getRentRealStates() {
        try {
            const response = await fetch("https://localhost:7149/PostRealEstateApi/GetTitleRentPostRealEstate");
            if (!response.ok) {
    ...
    return (
        <div className="pt-10 pl-52 pr-52">
            <div>
                <strong className='text-xl'>Thuê Nhà Việt Nam Cập Nhật Mới Nhất T1/2024</strong>
            </div>
            <div className='pt-5'>
